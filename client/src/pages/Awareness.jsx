...
const Awareness = () => {
  ...
  const faqs = [
    ...
    {
      q: 'How does the EcoClean reward points system work?',
    ...
    },
    {
      ...
      a: 'We highly recommend doing a factory reset and wiping all personal data from your smartphones, laptops, and hard drives before handing them to the collector. EcoClean and its certified recycling partners enforce secure data destruction, but pre-wiping is a best safety practice.',
    },
    {
