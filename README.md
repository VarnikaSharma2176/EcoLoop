# EcoClean | E-Waste Collection Management System

EcoClean is a production-ready MERN Stack (MongoDB, Express.js, React.js, Node.js) web application designed to streamline and gamify electronic waste recycling. 
